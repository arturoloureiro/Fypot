package com.example.fypot.presentation.signup
...
import com.example.fypot.ui.theme.SelectedField
import com.example.fypot.ui.theme.UnselectedField
        ...
        Button(onClick = {
            auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener { task ->
                if(task.isSuccessful){
                    Log.i("ariss", "REGISTER OK")
                }else{
                    Log.i("aris", "REGISTER LOGIN")
                }
            }
        }) {
            Text(text = "Sign Up")
